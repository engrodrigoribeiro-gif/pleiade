  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>Remanescente de Vegetação Nativa</se:Name>
          <se:Description>
            <se:Title>Remanescente de Vegetação Nativa</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>NOME</ogc:PropertyName>
              <ogc:Literal>Remanescente de Vegetação Nativa</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>APP a preservar</se:Name>
          <se:Description>
            <se:Title>APP a preservar</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>NOME</ogc:PropertyName>
              <ogc:Literal>APP a preservar</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>APP a recuperar</se:Name>
          <se:Description>
            <se:Title>APP a recuperar</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>NOME</ogc:PropertyName>
              <ogc:Literal>APP a recuperar</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>Reserva Legal Total</se:Name>
          <se:Description>
            <se:Title>Reserva Legal Total</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>NOME</ogc:PropertyName>
              <ogc:Literal>Reserva Legal Total</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>

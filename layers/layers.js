...
var lyr_SigcarTO_propriedade_area_imovel_completo = new ol.layer.Tile({
            source: new ol.source.TileWMS(({
                url: "http://mapas.semarh.to.gov.br:80/erdas-apollo/vector/SIGCAR_TOCANTINS_AREA_IMOVEL_COMPLETO?",
                attributions: '<a class="legend-realtime"><b>SigcarTO_propriedade_area_imovel_completo</b><br />\<img src="http://mapas.semarh.to.gov.br:80/erdas-apollo/vector/SIGCAR_TOCANTINS_AREA_IMOVEL_COMPLETO?VERSION=1.1.1&REQUEST=GetLegendGraphic&SERVICE=WMS&LAYER=propriedade_area_imovel_completo&STYLE=default&FORMAT=image/png&CONFIG=legendurl&"></a>',
                params: {
                "LAYERS": "propriedade_area_imovel_completo",
                //"TILED": "true",
                "VERSION": "1.1.1"},
            })),
            title: '<div id="layertitle">SigcarTO_propriedade_area_imovel_completo<br />\<i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend-realtime">\<img src="http://mapas.semarh.to.gov.br:80/erdas-apollo/vector/SIGCAR_TOCANTINS_AREA_IMOVEL_COMPLETO?VERSION=1.1.1&REQUEST=GetLegendGraphic&SERVICE=WMS&LAYER=propriedade_area_imovel_completo&STYLE=default&FORMAT=image/png&CONFIG=legendurl&"></a>',
            popuplayertitle: 'SigcarTO_propriedade_area_imovel_completo',
            permalink: 'SigcarTO_propriedade_area_imovel_completo',
            opacity: 1.000000,
            
            
            
            });
    wms_layers.push([lyr_SigcarTO_propriedade_area_imovel_completo, 0]);
    lyr_SigcarTO_propriedade_area_imovel_completo.setVisible(false);
    
var lyr_Processosminerriosativos = new ol.layer.Tile({
            source: new ol.source.TileWMS(({
                url: "https://geo.anm.gov.br/arcgis/services/SIGMINE/dados_anm/MapServer/WMSServer?",
                attributions: '<a class="legend-realtime"><b>Processos minerários ativos</b><br />\<img src="https://geo.anm.gov.br/arcgis/services/SIGMINE/dados_anm/MapServer/WMSServer?request=GetLegendGraphic&version=1.3.0&format=image/png&layer=4&"></a>',
                params: {
                "LAYERS": "4",
                //"TILED": "true",
                "VERSION": "1.3.0"},
            })),
            title: '<div id="layertitle">Processos minerários ativos<br />\<i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend-realtime">\<img src="https://geo.anm.gov.br/arcgis/services/SIGMINE/dados_anm/MapServer/WMSServer?request=GetLegendGraphic&version=1.3.0&format=image/png&layer=4&"></a>',
            popuplayertitle: 'Processos minerários ativos',
            permalink: 'Processosminerriosativos',
            opacity: 0.566000,
            
            
            
            });
    wms_layers.push([lyr_Processosminerriosativos, 0]);
    lyr_Processosminerriosativos.setVisible(false);
    
var lyr_ImoveisCertificadosSigefPublicoTO = new ol.layer.Tile({
            source: new ol.source.TileWMS(({
                url: "http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=certificada_sigef_publico_TO&",
                attributions: '<a class="legend-realtime"><b>Imoveis Certificados Sigef Publico TO</b><br />\<img src="http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=certificada_sigef_publico_TO&"></a>',
                params: {
                "LAYERS": "certificada_sigef_publico_TO",
                //"TILED": "true",
                "VERSION": "1.1.1"},
            })),
            title: '<div id="layertitle">Imoveis Certificados Sigef Publico TO<br />\<i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend-realtime">\<img src="http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=certificada_sigef_publico_TO&"></a>',
            popuplayertitle: 'Imoveis Certificados Sigef Publico TO',
            permalink: 'ImoveisCertificadosSigefPublicoTO',
            opacity: 0.618000,
            
            
            
            });
    wms_layers.push([lyr_ImoveisCertificadosSigefPublicoTO, 0]);
    lyr_ImoveisCertificadosSigefPublicoTO.setVisible(false);
    
var lyr_ImoveisCertificadosSigefParticularTO = new ol.layer.Tile({
            source: new ol.source.TileWMS(({
                url: "http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=certificada_sigef_particular_TO&",
                attributions: '<a class="legend-realtime"><b>Imoveis Certificados Sigef Particular TO</b><br />\<img src="http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=certificada_sigef_particular_TO&"></a>',
                params: {
                "LAYERS": "certificada_sigef_particular_TO",
                //"TILED": "true",
                "VERSION": "1.1.1"},
            })),
            title: '<div id="layertitle">Imoveis Certificados Sigef Particular TO<br />\<i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend-realtime">\<img src="http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=certificada_sigef_particular_TO&"></a>',
            popuplayertitle: 'Imoveis Certificados Sigef Particular TO',
            permalink: 'ImoveisCertificadosSigefParticularTO',
            opacity: 0.804000,
            
            
            
            });
    wms_layers.push([lyr_ImoveisCertificadosSigefParticularTO, 0]);
    lyr_ImoveisCertificadosSigefParticularTO.setVisible(false);
    
var lyr_ImoveisCertificadosSNCILei10267_2001PublicoTO = new ol.layer.Tile({
            source: new ol.source.TileWMS(({
                url: "http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=imoveiscertificados_publico_TO&",
                attributions: '<a class="legend-realtime"><b>ImoveisCertificadosSNCILei10267_2001PublicoTO</b><br />\<img src="http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=imoveiscertificados_publico_TO&"></a>',
                params: {
                "LAYERS": "imoveiscertificados_publico_TO",
                //"TILED": "true",
                "VERSION": "1.1.1"},
            })),
            title: '<div id="layertitle">ImoveisCertificadosSNCILei10267_2001PublicoTO<br />\<i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend-realtime">\<img src="http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=imoveiscertificados_publico_TO&"></a>',
            popuplayertitle: 'ImoveisCertificadosSNCILei10267_2001PublicoTO',
            permalink: 'ImoveisCertificadosSNCILei10267_2001PublicoTO',
            opacity: 0.684000,
            
            
            
            });
    wms_layers.push([lyr_ImoveisCertificadosSNCILei10267_2001PublicoTO, 0]);
    lyr_ImoveisCertificadosSNCILei10267_2001PublicoTO.setVisible(false);
    
var lyr_ImoveisCertificadosSNCILei10267_2001PrivadoTO = new ol.layer.Tile({
            source: new ol.source.TileWMS(({
                url: "http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=imoveiscertificados_privado_TO&",
                attributions: '<a class="legend-realtime"><b>ImoveisCertificadosSNCILei10267_2001PrivadoTO</b><br />\<img src="http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=imoveiscertificados_privado_TO&"></a>',
                params: {
                "LAYERS": "imoveiscertificados_privado_TO",
                //"TILED": "true",
                "VERSION": "1.1.1"},
            })),
            title: '<div id="layertitle">ImoveisCertificadosSNCILei10267_2001PrivadoTO<br />\<i class="fas fa-angle-up" id="secondImage"></i><i class="fas fa-angle-down" id="firstImage"></i></div><a class="layerlegend-realtime">\<img src="http://acervofundiario.incra.gov.br:80/i3geo/ogc.php?tema=imoveiscertificados_privado_TO&"></a>',
            popuplayertitle: 'ImoveisCertificadosSNCILei10267_2001PrivadoTO',
            permalink: 'ImoveisCertificadosSNCILei10267_2001PrivadoTO',
            opacity: 0.570000,
            
            
            
            });
    wms_layers.push([lyr_ImoveisCertificadosSNCILei10267_2001PrivadoTO, 0]);
    lyr_ImoveisCertificadosSNCILei10267_2001PrivadoTO.setVisible(false);

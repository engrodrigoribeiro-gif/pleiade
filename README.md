...
3. Marque para aplicar em Production e Preview. Os antigos mosaicos Planet foram retirados; não é necessária chave Planet.
4. Salve.
...
- 30 imóveis/OS e 94 produtos atuais.
- OS 01.03: Proposta CAR e Intervenções V2, mantendo o histórico V1 e o perímetro V1.
- OS 01.04: Fazenda Matheus Lopes Sul, identificador sequencial estável 30, quatro cartas.
- Limite da OS 01.04 derivado do PDF e identificado como aproximado. O ZIP contém somente esse limite, não um SHP temático completo. Os vetores originais continuam pendentes.
- A carta de intervenções V2 da Floresta mantém a divergência original entre a nota (7110,5840 ha) e a legenda (110,5840 ha), com aviso para revisão.
- Usar o conteúdo desta pasta na raiz do repositório, não o ZIP nem a planilha. Validar primeiro em Vercel Preview antes de promover a produção.
